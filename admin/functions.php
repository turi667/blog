...
function ImagePlaceholder($image=''){
 ...
 if(!$image){
     return '49aeb53fb1079b24682a6fca3f97fcd3.png';
 } else {
     return $image;
 }
...
function register_user($first_name,$last_name,$username, $email, $password){
    ...
    global $connection;
        ...
        echo 'alert("Account Confirmation Succesfull Please Go Check Your Email To Get Confirmed");';
 ...
 function login_user($username, $password)
 {
     ...
     while ($row = mysqli_fetch_array($select_user_query)) {
         ...
         $db_user_activ = $row['activated'];



         if (password_verify($password,$db_user_password) && $db_user_activ == 1)  {
      ...
      {
       setcookie ("username",$db_username,time()+ (10 * 365 * 24 * 60 * 60));
      ...
      else
      {
       ...
       header('Location: '.$_SERVER['REQUEST_URI']);
         ...
         if (password_verify($password,$db_user_password) && $db_user_activ == 0)  {

           echo '<script type="text/javascript">';
           echo 'alert("Please Go To Your Email To Verify Account");';
           echo 'window.location.href = "index.php";';
           echo '</script>';
        }
